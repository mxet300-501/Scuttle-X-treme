...
xRange = np.array([-49.318, 43.682])                         # range must be updated for your device
yRange = np.array([-46.445, 44.409])                        # range must be updated for your device
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # if(axes[0] < minimumX):
        #     minimumX = axes[0]
        # elif(axes[0] > maximumX):
        #     maximumX = axes[0]
            
        # if(axes[1] < minimumY):
        #     minimumY = axes[1]
        # elif(axes[1] > maximumY):
        #     maximumY = axes[1]
        # print("x min: ",minimumX," x max: ",maximumX)
        # print("y min: ",minimumY," y max: ",maximumY)        
